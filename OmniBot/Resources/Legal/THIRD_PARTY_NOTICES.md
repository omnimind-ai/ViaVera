...
declared licenses are listed in `Alpine-3.21.0-Packages.md`. Before public binary
...
bundled at `hterm-BSD-License.txt`.
...
`Lobe-Icons-License.md`. Provider names and logos may also be trademarks of
their respective owners; their inclusion does not imply affiliation or
endorsement.
