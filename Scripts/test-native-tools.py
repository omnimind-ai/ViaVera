...
SOURCES = [
    ...
    "App/NativeTools/NativeToolHostCapabilities.swift",
    "App/NativeTools/NativeToolSystemRequest.swift",
    "App/NativeTools/NativeToolSystemResult.swift",
    "App/NativeTools/NativeToolSystemPresentation.swift",
    "App/NativeTools/NativeToolOTPService.swift",
